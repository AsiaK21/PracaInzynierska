...
import 'package:projekt_inzynierski/chats_Joanna_Kozar/services/firebase_firestore_groups_service.dart';
import 'package:projekt_inzynierski/chats_Joanna_Kozar/services/firebase_realtime_database_groups_service.dart';
...
class ForumChatScreen extends StatefulWidget {
  ...
  const ForumChatScreen({Key? key, required this.bordowyKolor}) : super(key: key);
          ...
          children: [
            ...
            Opacity(
              ...
              child: IconButton(
                ...
                icon: Icon(
                  isRightGroupListExpanded ? Icons.arrow_forward : Icons.settings,
                ),
              ),
            ),
          ],
